...
export class EmuWasm {
    ...
    */
    tick() {
        wasm.emuwasm_tick(this.ptr);
    }
    /**
    */
    tick_timers() {
        wasm.emuwasm_tick_timers(this.ptr);
    }
    /**
    */
    reset() {
        wasm.emuwasm_reset(this.ptr);
    }
    /**
    ...
    */
    keypress(evt, pressed) {
        wasm.emuwasm_keypress(this.ptr, addHeapObject(evt), pressed);
    }
    /**
    * @param {Uint8Array} data
    */
    load_game(data) {
        wasm.emuwasm_load_game(this.ptr, addHeapObject(data));
    }
    /**
    * @param {number} scale
    */
    draw_screen(scale) {
        wasm.emuwasm_draw_screen(this.ptr, scale);
    }
}
